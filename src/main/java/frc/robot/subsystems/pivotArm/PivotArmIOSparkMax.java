...
public class PivotArmIOSparkMax implements PivotArmIO {
  ...
  public PivotArmIOSparkMax() {
    ...
    absoluteEncoder.setDistancePerRotation(
        2 * Constants.PI * PivotArmConstants.POSITION_CONVERSION_FACTOR);
    ...
    pidController =
        new ProfiledPIDController(
            PivotArmConstants.PIVOT_ARM_PID_REAL[0],
            PivotArmConstants.PIVOT_ARM_PID_REAL[1],
            PivotArmConstants.PIVOT_ARM_PID_REAL[2],
            new TrapezoidProfile.Constraints(2.45, 2.45));

    pidController.setTolerance(
        PivotArmConstants.PIVOT_ARM_PID_TOLERANCE,
        PivotArmConstants.PIVOT_ARM_PID_VELOCITY_TOLERANCE);
