...
public class ShooterIOSparkMax implements ShooterIO {
  ...
  public ShooterIOSparkMax() {
    leftMotor = new CANSparkMax(SHOOTER_LEFT_ID, CANSparkMax.MotorType.kBrushless);
    rightMotor = new CANSparkMax(SHOOTER_RIGHT_ID, CANSparkMax.MotorType.kBrushless);
