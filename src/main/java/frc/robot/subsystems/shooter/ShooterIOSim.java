...
public class ShooterIOSim implements ShooterIO {
  ...
  private final PIDController leftController =
      new PIDController(leftShooter.kP(), leftShooter.kI(), leftShooter.kD());
  private final PIDController rightController =
      new PIDController(rightShooter.kP(), rightShooter.kI(), rightShooter.kD());
  private SimpleMotorFeedforward leftFF =
      new SimpleMotorFeedforward(leftShooter.kS(), leftShooter.kV(), leftShooter.kA());
  private SimpleMotorFeedforward rightFF =
      new SimpleMotorFeedforward(rightShooter.kS(), rightShooter.kV(), rightShooter.kA());
  ...
  public void updateInputs(ShooterIOInputs inputs) {
    ...
    if (leftSetpointRPM != null) {
      ...
      leftSim.setInputVoltage(
          MathUtil.clamp(leftAppliedVolts, -12.0, 12.0)); // we are limiting the voltage
