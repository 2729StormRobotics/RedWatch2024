  ...
  public static class IndexerSimConstants {
    ...
    public static final double kMomentOfInertia =
        0.5
            * kCarriageMass
            * kIndexerDrumRadius
            * kIndexerDrumRadius; // Moment of inertia represents how resistant to force something
    // is

    // distance per pulse = (distance per revolution) / (pulses per revolution)
    // = (Pi * D) / ppr
    public static final double kIndexerEncoderDistPerPulse =
        2.0 * Math.PI * kIndexerDrumRadius / 4096;
  }
