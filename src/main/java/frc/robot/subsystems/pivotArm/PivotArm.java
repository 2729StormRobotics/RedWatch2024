...
public class PivotArm extends SubsystemBase {
    ...
    SysId =
        new SysIdRoutine(
            new SysIdRoutine.Config(
                Volts.per(Second).of(PivotArmConstants.RAMP_RATE),
                Volts.of(PivotArmConstants.STEP_VOLTAGE),
                null),
  ...
  public void periodic() {
    ...
    Logger.recordOutput(
        ...
        inputs.angleRads != PivotArmConstants.PIVOT_ARM_OFFSET);
  }
  ...
  public void addPID(double setpointAdd) {
    ...
    this.setpoint =
        MathUtil.clamp(
            this.setpoint,
            PivotArmConstants.PIVOT_ARM_MIN_ANGLE,
  ...
  public boolean atSetpoint() {
    return Math.abs(io.getAngle() - setpoint) < PivotArmConstants.PIVOT_ARM_PID_TOLERANCE
        && Math.abs(getVelocity()) < PivotArmConstants.PIVOT_ARM_PID_VELOCITY_TOLERANCE;
  }
  ...
  public Command quasistaticForward() {
    return SysId.quasistatic(Direction.kForward)
        ...
        .alongWith(
            new InstantCommand(
                () -> Logger.recordOutput("PivotArm/sysid-test-state-", "quasistatic-forward")));
  }
  ...
  public Command quasistaticBack() {
    return SysId.quasistatic(Direction.kReverse)
        ...
        .alongWith(
            new InstantCommand(
                () -> Logger.recordOutput("PivotArm/sysid-test-state-", "quasistatic-reverse")));
  }
  ...
  public Command dynamicForward() {
    return SysId.dynamic(Direction.kForward)
        ...
        .alongWith(
            new InstantCommand(
                () -> Logger.recordOutput("PivotArm/sysid-test-state-", "dynamic-forward")));
  }
  ...
  public Command dynamicBack() {
    return SysId.dynamic(Direction.kReverse)
        ...
        .alongWith(
            new InstantCommand(
                () -> Logger.recordOutput("PivotArm/sysid-test-state-", "dynamic-reverse")));
  }
}
